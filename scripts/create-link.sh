#!/bin/bash
# Script to create a short link via the CreateLinkCommand in the dev container
...
echo "🔗 Running create-link command..."
echo ""

# Run the command interactively
$DC exec -it "$APP_SERVICE" bash -c "cd backend && java -jar build/libs/$JAR_NAME --create-link --spring.main.web-application-type=none"
